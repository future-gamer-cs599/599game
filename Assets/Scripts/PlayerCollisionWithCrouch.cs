...
public class PlayerCollisionWithCrouch : MonoBehaviour
{
    public PlayerMovementWithCrouch movement;

    public PlayerMoveForwardWithCrouch moveForward;
    ...
    void OnCollisionEnter(Collision other){
        if (other.collider.tag == "Obstacle") {
            ...
            FindObjectOfType<GameManagerWithCrouch>().EndGame();
        }
    }
